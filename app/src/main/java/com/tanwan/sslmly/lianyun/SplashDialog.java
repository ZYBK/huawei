...
//                    Log.i("TAG", "关闭闪屏");
    ...
    public void showSplash(boolean isSdk) {
        this.isSdk=isSdk;
        this.show();
    ...
    protected void onCreate(Bundle bundle) {
        ...
        if(isSdk){
            setContentView(R.layout.not_splash_dialog);
            ((TextView)findViewById(R.id.tipsView)).setText("");
            ((TextView)findViewById(R.id.tipsView)).setTextColor(Color.parseColor("black"));
        }else {
